...
BEGIN
    ...
    SELECT
        ...
        -- FIX: Explicitly cast the result to REAL to match the function's return type
...
ALTER FUNCTION "public"."hybrid_search"("query_text" "text", "query_embedding" "public"."vector", "match_count" integer) OWNER TO "postgres";
...
BEGIN
  ...
  -- Using 'english' configuration to match the index
...
GRANT ALL ON FUNCTION "public"."hybrid_search"("query_text" "text", "query_embedding" "public"."vector", "match_count" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."hybrid_search"("query_text" "text", "query_embedding" "public"."vector", "match_count" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."hybrid_search"("query_text" "text", "query_embedding" "public"."vector", "match_count" integer) TO "service_role";
